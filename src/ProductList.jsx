...
function ProductList() {
    const cart = useSelector(state => state.cart.items || []); // Ensure cart is an array; // Select the cart items from the Redux store
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <span>({calculateTotalQuantity()})</span></h1></a></div>
            </div>
        </div>
        {!showCart? (
